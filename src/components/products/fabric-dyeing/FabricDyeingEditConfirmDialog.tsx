...
import { updateFabricDyeingConfirmAction } from '@/app/(app)/products/fabric-dyeing/actions'
...
export function FabricDyeingEditConfirmDialog({ history, open, onClose }: Props) {
