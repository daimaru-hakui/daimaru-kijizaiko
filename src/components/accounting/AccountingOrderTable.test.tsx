...
import { AccountingOrderTable } from './AccountingOrderTable'
import { getDefaultPeriod } from '@/lib/dates'
import type { SerializableHistory } from '../../../types'

vi.mock('next/navigation', () => ({
  useRouter: () => ({ refresh: vi.fn(), push: vi.fn() }),
  usePathname: () => '/accounting-dept/orders',
}))
...
describe('AccountingOrderTable', () => {
  it('金額確定ボタンと編集ボタンが表示される', () => {
    render(
    ...
    expect(screen.getByRole('button', { name: '金額確定' })).toBeInTheDocument()
...
describe('AccountingOrderTable リセット', () => {
