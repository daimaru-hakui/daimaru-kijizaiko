...
export default async function ProductsPage() {
  ...
  const db = getAdminDb()
  const [productsSnap, usersSnap, suppliersSnap, userDocSnap, schedulesSnap, stockPlacesSnap] =
    await Promise.all([
  ...
  const cuttingSchedulesMap: Record<string, CuttingSchedule> = Object.fromEntries(
